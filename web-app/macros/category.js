...
zk.$package('com.choranet.zk');
zk.load('zul.wgt', function () {
    com.choranet.zk.Categorybar = zk.$extends(zul.wgt.Div, {
        bind_: function () {
        ...
        _addScollEvent:function(){
            ...
            if(this.scrollEvent == false){	//only do at first time
                ...
                jq(this.$n("left")).mousedown(function () {
                    $cave.animate({
                        marginLeft: "0px"
                    }, Math.abs(zk.parseInt($cave.css('marginLeft'))/80) * 400);
                }).mouseup(stop);
                jq(this.$n("right")).mousedown(function () {
                    $cave.animate({
...
zk.load('zul.wgt', function () {
    com.choranet.zk.Category = zk.$extends(zul.wgt.Button, {
        _include : "",
        getInclude: function () {
            return this._include;
        },
        setInclude: function(include) {
            if (this._include != include) {
