...
abstract class SuperWindow extends Window {
    ...
    public SuperWindow (clazz, maxNb, attributsAFiltrer) throws Exception {
        initialisation(clazz, maxNb, attributsAFiltrer,true)
    }   
    
    /**
     * Constructeur
     **/
    public SuperWindow (clazz, Integer maxNb) throws Exception {
        initialisation(clazz, maxNb, null,true)
    }   
    ...
    public SuperWindow (clazz) throws Exception {
        initialisation(clazz, 9, null,true)
    }   
    
    public SuperWindow (clazz, Boolean loadList) throws Exception {
        initialisation(clazz, 9, null,loadList)
    }
    
    private void initialisation(clazz, maxNb, attributsAFiltrer,Boolean loadList) throws Exception {
        try {
