...
/**
 * PriseInformationService Service pour la gestion des opérations
 * transactionnelles pour l'objet PriseInformation
 */
class PriseInformationService extends SuperService {

    static transactional = true
    
    def list() throws Exception {
        return super.list(PriseInformation.class)
    }
    def getPriseInformationByPhase(projet,client){
                    
        def criteria = PriseInformation.createCriteria()
    ...
    def getPriseInformationByUtlisateur(utilisateur,ofs = null,maxNb = null){
